...
export const getRestaurents = async (req, res) => {
    try {
        ...
        if (location) {
            queryObj.location = { $regex: location, $option: "i" };
        }
        // sorting
...
export const getFeaturedRestaurents = async (req, res) => {
    try {
...
export const getRestaurentBySlug = async (req, res) => {
    try {
...
export const getRestaurentAvailability = async (req, res) => {
    try {
